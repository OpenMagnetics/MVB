...
class TestBobbin(unittest.TestCase):
    ...
    def test_standard_bobbin_cadquery(self):
        ...
        bobbin_data = {
            "family": "standard",
            "material": "nylon",
            "dimensions": {"wallThickness": 0.0005, "flangeThickness": 0.001, "flangeExtension": 0.002, "pinCount": 0, "pinDiameter": 0.0008, "pinLength": 0.003},
            "coordinates": [0, 0, 0],
            "rotation": [0, 0, 0],
        }

        winding_window = {"width": 0.01, "height": 0.02, "coordinates": [0.005, 0]}
    ...
    def test_standard_bobbin_with_pins_cadquery(self):
        ...
        bobbin_data = {
            "family": "standard",
            "material": "nylon",
            "dimensions": {"wallThickness": 0.0005, "flangeThickness": 0.001, "flangeExtension": 0.002, "pinCount": 8, "pinDiameter": 0.0008, "pinLength": 0.003},
            "coordinates": [0, 0, 0],
            "rotation": [0, 0, 0],
        }
    ...
    def test_bobbin_geometry_no_export(self):
        ...
        winding_window = {"width": 0.008, "height": 0.015, "coordinates": [0.004, 0]}

        b = builder.Builder("CadQuery")
        result = b.get_bobbin(bobbin_data, winding_window, name="test_bobbin_geom", output_path=self.output_path, export_files=False)
    ...
    def test_bobbin_with_rotation(self):
        ...
        bobbin_data = {"family": "standard", "dimensions": {"wallThickness": 0.0005, "flangeThickness": 0.001, "flangeExtension": 0.002, "pinCount": 0}, "rotation": [math.pi / 4, 0, 0]}

        winding_window = {"width": 0.01, "height": 0.02, "coordinates": [0.005, 0]}

        b = builder.Builder("CadQuery")
        result = b.get_bobbin(bobbin_data, winding_window, name="test_bobbin_rotated", output_path=self.output_path)
